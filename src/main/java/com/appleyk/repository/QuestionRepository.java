...
public interface QuestionRepository extends Neo4jRepository<Movie,Long> {
	...
	@Query("match(n:Insect) where n.name={name} return n.alias")
	String getInsectAlias(@Param("name") String name);

	@Query("match(n:Insect) where n.name={name} return n.region")
	String getInsectFrom(@Param("name") String name);

	@Query("match(n:Insect) where n.name={name} return n.character")
	String getInsectCharacter(@Param("name") String name);

	@Query("match(n:Insect) where n.name={name} return n.treatment")
	String getInsectTreatment(@Param("name") String name);

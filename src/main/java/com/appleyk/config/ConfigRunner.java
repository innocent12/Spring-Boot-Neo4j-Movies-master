...
public class ConfigRunner implements CommandLineRunner {
    ...
    @Value("${HanLP.CustomDictionary.path.insectDict}")
    private String insectDictPath;
    ...
    public void run(String... args){
        ...
        /**加载自定义的【昆虫】字典 == 设置词性 nbc 0*/
        loadDict(insectDictPath,3);
            ...
            while ((word = br.readLine()) != null) {
                switch (type) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        CustomDictWordUtils.setNatureAndFrequency(word, "nbc 0", true);
                        break;
                    default:
                        break;
                }

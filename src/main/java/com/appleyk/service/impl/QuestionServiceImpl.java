...
//                answer = getMoviesCount(reStrings);
            ...
            case 13:
                ...
                break;
            case 14:
                answer = "sorry,小主,我没有找到你要的答案";
                break;
            case 15:
                name = reStrings.get(1);
                answer = questionRepository.getInsectAlias(name);
                break;
            case 16:
                name = reStrings.get(1);
                answer = questionRepository.getInsectFrom(name);
                break;
            case 17:
                name = reStrings.get(1);
                answer = questionRepository.getInsectCharacter(name);
                break;
            case 18:
                name = reStrings.get(1);
                answer = questionRepository.getInsectTreatment(name);
                break;
            default:
                answer = "很抱歉，系统暂没有收录此信息";
                break;
        }
